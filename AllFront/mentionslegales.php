...
<html>
    ...
    <body>
        <section class="pageMentionsLegales">
            ...
            <p class="textmlegalestitle">ARTICLE 3 : Collecte des données</p>
            <p class="textmlegalestext">
            ...
            <p class="textmlegalestitle">ARTICLE 4 : Propriété intellectuelle</p>
            <p class="textmlegalestext">
            Sauf mention contraire, tous les éléments accessibles sur le site (textes, images, graphismes, logo, icônes, sons, logiciels, etc.) restent la propriété exclusive de leurs auteurs en ce qui concerne les droits de propriété intellectuelle ou les droits d’usage. Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site, peu importe le moyen ou le procédé utilisé, est interdite et passible de poursuites. Les marques et logos reproduits sur le site sont déposés par les sociétés qui en sont propriétaires.
            </p>
            ...
            <p class="textmlegalestitle">ARTICLE 8 : Publication par l’Utilisateur</p>
            <p class="textmlegalestext">
            Le site permet aux membres de publier les contenus suivants : <br>
            - Commentaires <br>
            - Réactions (likes et unlike) <br>
            Dans ses publications, le membre s’engage à respecter les règles de bonne conduite de l’internet et les règles de droit en vigueur. <br>
            Le site peut exercer une modération sur les publications et peut refuser leur mise en ligne, sans avoir à s’en justifier auprès du membre. Le membre reste titulaire de l’intégralité de ses droits de propriété intellectuelle. La société fera figurer le nom du membre à proximité de chaque utilisation de sa publication.
            </p>
    </div>
        </section>
    </body>
